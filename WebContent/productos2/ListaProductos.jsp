...
<title>Lista Productos (DATE)</title>
...
<body>
	...
	<table>
		...
		<c:forEach var="prod" items="${LISTAPRODUCTOS}">
			...
			<c:url var="linkTemp" value="ControladorProductos2">
				<c:param name="instruccion" value="cargar"></c:param>
				<c:param name="CArticulo" value="${prod.cArt}"></c:param>
			</c:url>

			<c:url var="linkTempEliminar" value="ControladorProductos2">
...
<%-- 			<td><a href="ControladorProductos2?instruccion=cargar&CArticulo=${prod.cArt}">Actualizar</a>&nbsp;<a href="${linkTempEliminar}">Eliminar</a></td> --%>
...
<%-- 				<td>${prod.getpOrig()}</td> --%>
	...
	<c:url var="linkActualizar" value="ControladorProductos2">
		<c:param name="instruccion" value="listar"></c:param>
		<c:param name="excepcion" value="null"></c:param>
	</c:url>	

	<div id="contenedorBoton">
		<input type="button" value="Insertar Registro" onclick="window.location.href='productos2/inserta_producto.jsp'"/>
		<br/>
